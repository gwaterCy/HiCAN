...
if __name__ == '__main__':
    ...
    parser.add_argument('--dropouts', type=list, default=[0,0.1,0.25], help='patience of bad result')
    ...
    if opt.dataset == 'diginetica':
        path_train = "./data/narm_digweek_train.txt"
        path_test = "./data/narm_digweek_test.txt"
        num_item = 43098
    elif opt.dataset == 'rsc_64' :
        path_train = "./data/narm_rsc_64_train.txt"
        path_test = "./data/narm_rsc_64_test.txt"
        num_item = 17695
    elif opt.dataset == 'rsc_4':
        path_train = "./data/narm_rsc_4_train.txt"
        path_test = "./data/narm_rsc_4_test.txt"
        num_item = 30661
    elif opt.dataset == 'retail':
        path_train = "./data/narm_retail_train.txt"
        path_test = "./data/narm_retail_test.txt"
        num_item = 32054
    ###load data
    ...
    ###model
    model = HiCAN(batch_size=opt.batchSize,
